...
seeds=50; %This this is used to determine best fit of model in validation
male_d=4;
female_d=3;
...
for n=1:tt   
    UK_t(1:ag,n)=uk1(sa+1+3108+(n-1)*111:3108+111*n-20,1);
end
...
lnUK_ct; %Centering ln(mx) of UK 
% Validation Set 
UK_v =zeros(ag,qq); %Validation Matrix
for n=1:qq
    UK_v(1:ag,n)=uk1(sa+1+3108+111*tt+(n-1)*111:111*tt+3108+111*n-20,1);
end
...
zzz=zeros(ag,tt); 
for n=1:tt   
    zzz(1:ag,n)=che1(sa+1+8214+(n-1)*111:8214+111*n-20,1);
end
...
for n=1:qq
    qqq(1:ag,n)=che1(sa+1+8214+111*tt+(n-1)*111:8214+111*tt+111*n-20,1);
end
lnCHE_v=log(qqq);  %the ln(m) of 
...
for n=1:tt   
    zzz(1:ag,n)=dnk1(sa+1+12765+(n-1)*111:12765+111*n-20,1);
end
...
qqq =zeros(ag,qq); %Validation Matrix
for n=1:qq
    qqq(1:ag,n)=dnk1(sa+1+12765+111*tt+(n-1)*111:12765+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); 
for n=1:tt   
    zzz(1:ag,n)=esp1(sa+1+4662+(n-1)*111:4662+111*n-20,1);
end
...
qqq =zeros(ag,qq); %Validation Matrix
for n=1:qq
    qqq(1:ag,n)=esp1(sa+1+4662+111*tt+(n-1)*111:4662+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); 
for n=1:tt   
    zzz(1:ag,n)=fin1(sa+1+7992+(n-1)*111:7992+111*n-20,1);
end
...
qqq =zeros(ag,qq); %Validation Matrix
for n=1:qq
    qqq(1:ag,n)=fin1(sa+1+7992+111*tt+(n-1)*111:7992+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); 
for n=1:tt   
    zzz(1:ag,n)=ita1(sa+1+8658+(n-1)*111:8658+111*n-20,1);
end
...
qqq =zeros(ag,qq); % Validation Matrix
for n=1:qq
    qqq(1:ag,n)=ita1(sa+1+8658+111*tt+(n-1)*111:8658+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt);
for n=1:tt   
    zzz(1:ag,n)=nld1(sa+1+11100+(n-1)*111:11100+111*n-20,1);
end
...
qqq =zeros(ag,qq); % Validation Matrix
for n=1:qq
    qqq(1:ag,n)=nld1(sa+1+11100+111*tt+(n-1)*111:11100+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %
for n=1:tt   
    zzz(1:ag,n)=nor1(sa+1+11544+(n-1)*111:11544+111*n-20,1);
end
...
qqq =zeros(ag,qq); % Validation Matrix
for n=1:qq
    qqq(1:ag,n)=nor1(sa+1+11544+111*tt+(n-1)*111:11544+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); 
for n=1:tt   
    zzz(1:ag,n)=swe1(sa+1+22089+(n-1)*111:22089+111*n-20,1);
end
...
qqq =zeros(ag,qq); %Validation Matrix
for n=1:qq
    qqq(1:ag,n)=swe1(sa+1+22089+111*tt+(n-1)*111:22089+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=fra1(sa+1+14874+(n-1)*111:14874+111*n-20,1);
end
...
qqq =zeros(ag,qq); %Validation Matrix
for n=1:qq
    qqq(1:ag,n)=fra1(sa+1+14874+111*tt+(n-1)*111:14874+111*tt+111*n-20,1);
end
...
%We will test all these 50 seeds's RMSE to determine the best fit.
TT_t=zeros(ag,tt,cc);
TT_t(:,:,1)=lnSWE_t;
TT_t(:,:,2)=lnUK_t;
...
for i=1:xx;
    ...
    RMSE_rank3(i,j,rr)=rms3d(CP_rank3d); %50 times of RMSEs
    end
    end
end
clear m;
...
for i=1:xx;
    ...
    RMSE_rank4(i,j,rr)=rms3d(CP_rank4d); %50 times of RMSEs
    end
    end
end
clear m;
...
for i=1:xx;
    ...
    RMSE_rank5(i,j,rr)=rms3d(CP_rank5d); %50 times of RMSEs
    end
    end
end
clear m;
...
for i=1:xx;
    ...
    RMSE_rank6(i,j,rr)=rms3d(CP_rank6d); %50 times of RMSEs
    end
    end
end
clear m;
...
for i=1:xx;
    ...
    RMSE_rank7(i,j,rr)=rms3d(CP_rank7d); %50 times of RMSEs
    end
    end
end
clear m;
...
for i=1:xx;
    ...
    RMSE_rank8(i,j,rr)=rms3d(CP_rank8d); %50 times of RMSEs
    end
    end
end
clear m;
...
for i=1:xx;
    ...
    RMSE_rank9(i,j,rr)=rms3d(CP_rank9d); %50 times of RMSEs
    end
    end
end
clear m;
...
for i=1:xx;
    ...
    RMSE_rank10(i,j,rr)=rms3d(CP_rank10d); %50 times of RMSEs
    end
    end
end
clear m;
