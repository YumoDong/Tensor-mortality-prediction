...
for n=1:tt   
    UK_t(1:ag,n)=uk1(1+0+(n-1)*111:0+111*n-20,1);
...
for n=1:qq
    UK_v(1:ag,n)=uk1(1+111*tt+(n-1)*111:111*tt+111*n-20,1);
end
...
for n=1:tt   
    zzz(1:ag,n)=che1(1+5106+(n-1)*111:5106+111*n-20,1);
end
...
for n=1:qq
    qqq(1:ag,n)=che1(1+5106+111*tt+(n-1)*111:5106+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=dnk1(1+9657+(n-1)*111:9657+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=dnk1(1+9657+111*tt+(n-1)*111:9657+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=esp1(1+1554+(n-1)*111:1554+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=esp1(1+1554+111*tt+(n-1)*111:1554+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=fin1(1+4884+(n-1)*111:4884+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=fin1(1+4884+111*tt+(n-1)*111:4884+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=ita1(1+5550+(n-1)*111:5550+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=ita1(1+5550+111*tt+(n-1)*111:5550+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=nld1(1+7992+(n-1)*111:7992+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=nld1(1+7992+111*tt+(n-1)*111:7992+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=nor1(1+8436+(n-1)*111:8436+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=nor1(1+8436+111*tt+(n-1)*111:8436+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=swe1(1+18981+(n-1)*111:18981+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=swe1(1+18981+111*tt+(n-1)*111:18981+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); %(91 ages * tt years)
for n=1:tt   
    zzz(1:ag,n)=fra1(1+11766+(n-1)*111:11766+111*n-20,1);
end
...
qqq =zeros(ag,qq); %(91 ages * qq years) Validation Matrix
for n=1:qq
    qqq(1:ag,n)=fra1(1+11766+111*tt+(n-1)*111:11766+111*tt+111*n-20,1);
end
...
SWE_new =zeros(ag,qq); %Forecasting Matrix
UK_new =zeros(ag,qq);
CHE_new =zeros(ag,qq);
DNK_new =zeros(ag,qq);
ESP_new =zeros(ag,qq);
...
FRA_new =zeros(ag,qq);
for n=1:qq
    SWE_new(:,n)=swe1(1+18981+111*(tt+qq)+(n-1)*111:18981+111*(tt+qq)+111*n-20,1);
    UK_new(:,n)=uk1(1+111*(tt+qq)+(n-1)*111:111*(tt+qq)+111*n-20,1);
    CHE_new(:,n)=che1(1+5106+111*(tt+qq)+(n-1)*111:5106+111*(tt+qq)+111*n-20,1);
    DNK_new(:,n)=dnk1(1+9657+111*(tt+qq)+(n-1)*111:9657+111*(tt+qq)+111*n-20,1);
    ESP_new(:,n)=esp1(1+1554+111*(tt+qq)+(n-1)*111:1554+111*(tt+qq)+111*n-20,1);
    FIN_new(:,n)=fin1(1+4884+111*(tt+qq)+(n-1)*111:4884+111*(tt+qq)+111*n-20,1);
    ITA_new(:,n)=ita1(1+5550+111*(tt+qq)+(n-1)*111:5550+111*(tt+qq)+111*n-20,1);
    NLD_new(:,n)=nld1(1+7992+111*(tt+qq)+(n-1)*111:7992+111*(tt+qq)+111*n-20,1);
    NOR_new(:,n)=nor1(1+8436+111*(tt+qq)+(n-1)*111:8436+111*(tt+qq)+111*n-20,1);
    FRA_new(:,n)=fra1(1+11766+111*(tt+qq)+(n-1)*111:11766+111*(tt+qq)+111*n-20,1);
end
%
