...
% short-term 5 years
cpd_5=load('rmse_A5_US_CPD.mat');
svd_5=load('rmse_A5_US_SVD.mat');
tucker_5aaa=load('rmse_A5_US_tuckeraaa.mat');
tucker_5aab=load('rmse_A5_US_tuckeraab.mat');
tucker_5abc=load('rmse_A5_US_tuckerabc.mat');
...
xlabel('Ages') 
ylabel('RMSFE')
title('The RMSFEs for Total population, USA (Short-term 5 yesrs, Frame A)','FontSize',12)
legend('SVD','CPD','Tucker(aaa)','Tucker(aab)','Tucker(abc)')

% Mid-term 10 years
cpd_10=load('rmse_A10_US_CPD.mat');
svd_10=load('rmse_A10_US_SVD.mat');
tucker_10aaa=load('rmse_A10_US_tuckeraaa.mat');
tucker_10aab=load('rmse_A10_US_tuckeraab.mat');
tucker_10abc=load('rmse_A10_US_tuckerabc.mat');
...
xlabel('Ages') 
ylabel('RMSFE')
title('The RMSFEs for Total population, USA (Mid-term 10 yesrs, Frame A)','FontSize',12)
legend('SVD','CPD','Tucker(aaa)','Tucker(aab)','Tucker(abc)')

% Long-term 20 years
cpd_20=load('rmse_A20_US_CPD.mat');
svd_20=load('rmse_A20_US_SVD.mat');
tucker_20aaa=load('rmse_A20_US_tuckeraaa.mat');
tucker_20aab=load('rmse_A20_US_tuckeraab.mat');
tucker_20abc=load('rmse_A20_US_tuckerabc.mat');
...
xlabel('Ages') 
ylabel('RMSFE')
title('The RMSFEs for Total population, USA (Long-term 20 yesrs, Frame A)','FontSize',12)
legend('SVD','CPD','Tucker(aaa)','Tucker(aab)','Tucker(abc)')
