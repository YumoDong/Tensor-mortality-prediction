...
%impute real observations 1990-1999
...
%We need to use new test set and fit a new Target tensor.
 %log(mx) of UK 
...
%
%impute real log(observations) 91*(1922+tt+qq to 2012)*3
...
%RMSE of rank 6 forecast and country specific RMSE.
RMSE_cpnew= Realob_new-FCD_cpnewb; %get the difference between the real and the forecst 1.
RMSE_new=rms3d(RMSE_cpnew); %the RMSE of rank 6 tensor add the mean back.
