...
CHE1=load('USA.mat'); %CHE represents US female
yyy=CHE1.USA;
xxx=yyy(:,female_d);   
...
MeanCHE1=mean(lnCHE_t,2); % the mean of log(mx) at a given age 
...
DNK1=load('USA.mat'); %DNK represents the US male
yyy=DNK1.USA;
xxx=yyy(:,male_d);  
...
%We need to use a new training set and fit a new Target tensor.
 %log(mx) of UK 
...
%RMSE of rank 6 forecast and gender specific RMSE.
