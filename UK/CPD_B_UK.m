...
zzz=zeros(ag,tt); 
for n=1:tt   
    zzz(1:ag,n)=che1(1+3108+20+(n-1)*111:3108+111*n-20,1);
end
...
for n=1:qq
    qqq(1:ag,n)=che1(1+3108+20+111*tt+(n-1)*111:3108+111*tt+111*n-20,1);
end
...
zzz=zeros(ag,tt); 
for n=1:tt   
    zzz(1:ag,n)=dnk1(1+3108+20+(n-1)*111:3108+111*n-20,1);
end
...
qqq =zeros(ag,qq); % Validation Matrix
for n=1:qq
    qqq(1:ag,n)=dnk1(1+20+3108+111*tt+(n-1)*111:3108+111*tt+111*n-20,1);
end
...
for n=1:qq
   ...
   CHE_new(:,n)=che1(1+3108+20+111*(tt+qq)+(n-1)*111:3108+111*(tt+qq)+111*n-20,1);
    DNK_new(:,n)=dnk1(1+3108+20+111*(tt+qq)+(n-1)*111:3108+111*(tt+qq)+111*n-20,1);
...
%RMSE offorecast and country specific RMSE.
